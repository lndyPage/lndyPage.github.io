$(document).ready(function() {
	...
	$(".arrow-bottom").click(function() {
      ...
      $(".sozda-top").click(function() {
		$("html, body").animate({ scrollTop: $(".main-head").height()+120 }, "slow");
		return false;
	});
    $(".admin-top").click(function() {
		$("html, body").animate({ scrollTop: $(".main-head").height()+820 }, "slow");
		return false;
	});
      $(".Indy-top").click(function() {
		$("html, body").animate({ scrollTop: $(".main-head").height()+1620 }, "slow");
		return false;
	});
       $(".work-top").click(function() {
		$("html, body").animate({ scrollTop: $(".main-head").height()+2420 }, "slow");
		return false;
	});
   $(".commend-top").click(function() {
		$("html, body").animate({ scrollTop: $(".main-head").height()+3220 }, "slow");
		return false;
	});
     $(".cont-top").click(function() {
		$("html, body").animate({ scrollTop: $(".main-head").height()+4020 }, "slow");
		return false;
	});
    
    ///////////////////////////////////////////////////////////////////////////////////////
    	$(".active-bot").click(function() {
		$("html, body").animate({ scrollTop:0 }, "slow");
		return false;
	});

      $(".sozda-bot").click(function() {
		$("html, body").animate({ scrollTop: $(".main-head").height()+120 }, "slow");
		return false;
	});
    $(".admin-top").click(function() {
...
$(".section-head").animated("fadeInLeft");
	...
	$(".homesect .section-bottom .buttons .s2-item").click(function() {
